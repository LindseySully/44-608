"""The purpose is to use this program to understand the min() and max() functions. Written by Lindsey Sullivan"""
...
#Reasearched how to make a questionaire in python using if else statements and else if. Then learned that the def statement in python 
#starts the body of a function and can be called on if the user doesn't give the correct inital input for choice. I also wanted to 
#make it so the entry wasn't case sensative either by adding the lower() function
def question1():
